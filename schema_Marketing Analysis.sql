...
-- Create the table
CREATE TABLE Marketing_transactions (
...
-- Insert data into the table
INSERT INTO Marketing_transactions (transaction_id, product_id, quantity, purchase_date)
VALUES
(1, 2, 2, '2023-06-02'),
(2, 14, 1, '2023-06-02'),
(3, 5, 2, '2023-06-05'),
...
Select  mc.campaign_id,mc.campaign_name from marketing_campaigns AS mc join Marketing_transactions AS mt  on 
 mc.product_id= mt.product_Id
